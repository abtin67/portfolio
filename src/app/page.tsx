...
import PortfolioCart from "@/components/portfolioCart/page";
...
export default function Home() {
  ...
  return (
    <>
      <div id="hero" className={`w-full  dark:bg-slate-800 dark:text-gray-200  mt-8 px-[8%] lg:px-[12%]`}>
        ...
        >
          <span className="text-gray-950 dark:text-gray-300 dark:text-shadow-sm dark:text-shadow-amber-200">سلام من فریدون هستم</span>
        </motion.h1>
        ...
        >
          توسعه دهنده فرانت اند با react.s,next.js,tailwindcss
        </motion.div>
